...
📝 团队 Git 协作规范
主分支保护：禁止直接向 main 分支 push 代码！

分支命名：开发新功能拉取 feature/xxx 分支，修复 bug 拉取 fix/xxx 分支。开发完成后提交 PR (Pull Request) 合并到 dev 分支。

Commit 规范：

feat: 新增功能 (例如: feat: 新增用户登录接口)

fix: 修复缺陷 (例如: fix: 修复工单状态更新异常)
